...
public class AppUtils
{
    ...
    public static void applyAdapterName(NetworkDevice.Connection connection)
    {
        ...
        List<com.genonbeta.TrebleShot.util.AddressedInterface> interfaceList = com.genonbeta.TrebleShot.util.NetworkUtils.getInterfaces(true, AppConfig.DEFAULT_DISABLED_INTERFACES);

        for (com.genonbeta.TrebleShot.util.AddressedInterface addressedInterface : interfaceList) {
            if (com.genonbeta.TrebleShot.util.NetworkUtils.getAddressPrefix(addressedInterface.getAssociatedAddress())
                    .equals(com.genonbeta.TrebleShot.util.NetworkUtils.getAddressPrefix(connection.ipAddress))) {
        ...
        if (logFile != null) {
            try {
                intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION)
                        .putExtra(Intent.EXTRA_STREAM, (com.genonbeta.TrebleShot.util.FileUtils.getSecureUri(activity, logFile)));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    {
        DocumentFile saveDirectory = com.genonbeta.TrebleShot.util.FileUtils.getApplicationDirectory(context);
        String fileName = com.genonbeta.TrebleShot.util.FileUtils.getUniqueFileName(saveDirectory, "trebleshot_log.txt", true);
    ...
    public static SuperPreferences getDefaultPreferences(final Context context)
    {
        if (mDefaultPreferences == null) {
            ...
            mDefaultPreferences.setOnPreferenceUpdateListener(new SuperPreferences.OnPreferenceUpdateListener()
            {
                ...
                {
                    com.genonbeta.TrebleShot.util.PreferenceUtils.syncPreferences(superPreferences, getDefaultLocalPreferences(context).getWeakManager());
                }
            });
        }
    ...
    public static SuperPreferences getDefaultLocalPreferences(final Context context)
    {
        if (mDefaultLocalPreferences == null) {
            ...
            mDefaultLocalPreferences.setOnPreferenceUpdateListener(new SuperPreferences.OnPreferenceUpdateListener()
            {
                ...
                public void onPreferenceUpdate(SuperPreferences superPreferences, boolean commit)
                {
                    com.genonbeta.TrebleShot.util.PreferenceUtils.syncPreferences(superPreferences, getDefaultPreferences(context).getWeakManager());
                }
            });
        }
